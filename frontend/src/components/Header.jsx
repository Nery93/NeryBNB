    ...
    return (
        ...
        <header className='shadow-md'>
            ...
            <div className='flex justify-between items-center p-4 md:p-6 max-w-7xl mx-auto text-black'>
                ...
                <div className="hidden lg:flex items-center border border-gray-300 rounded-full overflow-hidden px-4 pl-6 py-2 shadow-md">
                ...
                <div className="flex lg:hidden items-center border border-gray-300 rounded-full px-4 py-2 shadow-md hover:shadow-lg transition-shadow cursor-pointer">
                ...
                <div className='flex items-center gap-1 md:gap-2 rounded-full border border-gray-300 py-2 pr-2 md:pr-4 pl-3 md:pl-6'>
                    ...
                    <p className="hidden md:block">Nery</p>
