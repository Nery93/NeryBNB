        ...
        <div className='shadow-md'>
            <div className='flex justify-between items-center p-6 max-w-7xl mx-auto  text-black '>
                <div className="flex items-center">
                    ...
                    <p className='font-bold text-2xl text-primary-400'>NeryBNB</p>
                </div>

                <div className="flex items-center border border-gray-300 rounded-full overflow-hidden px-4 pl-6 py-2 shadow-md">
